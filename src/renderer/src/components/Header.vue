<template>
  <header class="bar flex justify-between items-center bg-gray-800 text-white">
    <div
      class="tabs-container text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 no-drag"
    >
      <ul class="flex flex-wrap -mb-px">
        ...
        <li class="me-2">
          <button
            class="no-drag px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white"
            @click="newTab"
          >
            +
          </button>
